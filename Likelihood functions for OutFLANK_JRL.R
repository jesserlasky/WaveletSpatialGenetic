...
EffectiveNumberSamplesMLE=function(FstVect, Fstbar, NumberOfSamples, SmallestFstInTrimmedList, LargestFstInTrimmedList){
  ...
  optim(NumberOfSamples, localNLLAllData, lower=1, method="L-BFGS-B")$par #I changed this because large scale wavelets are distributed often with apparent df < 2.
}
